      ...
      case 'cash':
        return (
          <div className="flex items-center">
            <Truck className={`${sizeClasses[size]} text-black mr-2`} style={{ color: 'black' }} />
      ...
      case 'card':
        return (
          <div className="flex items-center space-x-2">
            <CreditCard className={`${sizeClasses[size]} text-black`} style={{ color: 'black' }} />
      ...
      case 'bkash':
        return (
          <div className="flex items-center">
            ...
            <div className="flex flex-col">
              <span className="font-bold text-black" style={{ color: 'black' }}>bKash</span>
            </div>
          </div>
        );
      default:
