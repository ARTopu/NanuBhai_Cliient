...
const slides = [
  {
    ...
    subtitle: 'Everything you need for perfect baking',
  },
];
  ...
  return (
    <section className="py-8 md:py-12">
      ...
      <div className="text-center mb-6">
        <h2 className="text-2xl md:text-3xl font-extrabold" style={{ color: '#000000' }}>Baking Tools</h2>
      </div>
